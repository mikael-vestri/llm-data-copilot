WITH all_combinations_nova AS (
    ...
    LEFT JOIN main.public.nova_office o ON o.id = c.office_id
    LEFT JOIN main.public.nova_consultant con ON con.id = c.consultant_id
...
ON a.client = current_data_nova.client
   ...
   AND a.office = current_data_nova.office
   AND a.consultant = current_data_nova.consultant;